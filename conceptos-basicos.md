...
**Una LiveConnection establece una conexión a una capa semántica como Analysis Services o un conjunto de datos de Power BI**. En un escenario empresarial, es importante tener una capa semántica ubicada entre sus sistemas de origen de datos y Power BI, ya que simplifica los datos en el almacén de datos al hacerlos más utilizables para la empresa. Además, alinea datos complejos con términos comerciales familiares y elimina la necesidad de realizar cualquier preparación de datos, por lo que ofrece una vista completa y consolidada en toda la organización.

![Conectividad en vivo obtener datos](https://i.imgur.com/pRJdHD1.png)

![Iconos de LiveConnection](https://i.imgur.com/PHfyNOv.png)

*   Con los _**modelos de conectividad Compuestos**_, podemos **combinar datos de varias fuentes de datos de DirectQuery y mezclar datos de una fuente de datos de importación**. Por ejemplo, podemos establecer una conexión DirectQuery a la tabla de hechos de ventas y varias tablas de dimensiones desde un almacenamiento de datos SQL e ingerir datos mediante una importación desde una hoja de cálculo de Excel que contiene valores de presupuesto. En la aplicación Power BI Desktop, notará que el modo de almacenamiento está configurado en Mixto en la parte inferior derecha, como se muestra a continuación

    ![Iconos compuestos](https://i.imgur.com/JXpfw1e.png)
