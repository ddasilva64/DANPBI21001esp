...
* Con _**conectividad DirectQuery**_ no se ingiere ni almacena ningún dato en el modelo de Power BI. Power BI solo almacenará los metadatos de los datos subyacentes, por lo tanto, los nombres de las tablas, las relaciones, los nombres de los campos, etc., pero no los datos reales. Al no almacenar ningún dato en el modelo de Power BI, significa que podemos almacenar mayores volúmenes de datos y hay menos posibilidades de que encontremos alguna de las limitaciones de volumen de datos en el conjunto de datos de Power BI< /u>, como el conjunto de datos de 1 GB que viene con la licencia Pro. DirectQuery solo está disponible con fuentes de bases de dato
